...
class UltrasonicSensor:
    def __init__(
        self,
        trig_pin: int = settings.ULTRASONIC_TRIG_PIN,
        echo_pin: int = settings.ULTRASONIC_ECHO_PIN,
    ):
    ...
    def get_distance(self) -> Optional[float]:
        """Return distance in centimeters or None when invalid or timed out."""
        self.initialize()
        ...
        try:
            ...
            while GPIO.input(self.echo_pin) == 1:
                ...
                if pulse_end - wait_start > timeout:
                    return None
